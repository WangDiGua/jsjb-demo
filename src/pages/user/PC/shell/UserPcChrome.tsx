...
export default function UserPcChrome() {
  ...
  return (
    <div className="portal-pc portal-skin portal-hall-bg min-h-screen bg-surface font-body text-on-surface selection:bg-secondary/20">
      <ScrollToTop />
      <PortalHeader />
      {/*
      ...
      */}
      <main className="overflow-x-hidden pt-28">
        <div className="mx-auto w-full max-w-[var(--layout-max,1600px)] px-[var(--layout-px,2rem)] pb-[var(--layout-py-main,2.5rem)] pt-4">
          <PageOutletTransition>
            <Outlet />
          </PageOutletTransition>
        </div>
